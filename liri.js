    ...
    switch (response.command) {
      ...
      case "spotify":
        inquirer
          ...
          .catch(error => {
            console.log(
              `Hmmm, something went wrong (Error: ${error.message}). Try again!`
            );
          });
        break;
      ...
      case "omdb":
        inquirer
          ...
          .catch(error => {
            console.log(
              `Hmm, something went wrong (Error: ${error.message}). Try again!`
            );
          });
        break;
          ...
          .prompt([
            {
              ...
              name: "bandsintownArg",
              message:
                "Which band or musical artist's upcoming tour dates do you want to see?",
              validate: helpers.validateThis
            }
          ])
          .then(response => {
