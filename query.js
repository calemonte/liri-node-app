...
function queryBandsInTown(response){
    ...
    const artist = (response.bandsintownArg) ? helpers.capitalize(response.bandsintownArg) : helpers.capitalize(response);
...
function queryOMDB(response) {
    ...
    const movie = (response.omdbArg) ? helpers.capitalize(response.omdbArg) : helpers.capitalize(response);
